        ...
        {events.map((ev, i) => {
          ...
          return (
            <g key={ev.id}>
              ...
              {/* Title — Milky Cream for the playful rounded handwritten look */}
              <text x={lx} y={ly - 8} textAnchor="middle" fontFamily="'Milky Cream', 'Caveat', cursive" fontSize="13" fill="var(--sketch-fg)" fontWeight="400" style={{ letterSpacing: '0.02em' }}>{ev.title}</text>
